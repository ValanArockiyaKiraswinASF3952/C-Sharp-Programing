...
namespace MultiLevelInhertance
{
    ...
    public class StudentDetails:Employement,IMarkDetails
    {
        ...
        public StudentDetails(string studentID, string aid, string name,string fatherName, Gender gender, int phone,Department department,string year):base(aid, name,fatherName,gender,phone)
        {
