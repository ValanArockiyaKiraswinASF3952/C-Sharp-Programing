namespace Ex2
{
    public class Eco:Car,IBrand
    {
        ...
        public Eco(string fuleType,int numberOfSeats,string color,int tankCapacity,int numberOfKmDriven,int engineNumber,int chasisNumber):base( fuleType, numberOfSeats, color, tankCapacity, numberOfKmDriven)
        {
            CarID="CID"+s_carI++;
